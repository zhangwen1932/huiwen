export default {
  ...
  "about.core.id2.desc": 'Wyvern Advisory does not sell any products in return for payment, as this presents a potential conflict of interest. Wyvern Advisory only adopts sustainable approach through a clear and transparent model that charges consultancy and management fees.',
  "about.core.id3.title": 'Security & Confidentiality',
  "about.core.id3.desc": 'Professional ethics and industry conduct are upheld to the highest standard by Wyvern Advisory, which adheres to strict local and international laws and regulations in all aspects of its services. All client information will be managed according to the highest standards of confidentiality.',
  "about.core.id4.title": ' Optimising Controls',
  "about.core.id4.desc": 'Wyvern Advisory acts as an internal advisor to its clients, helping them at trust level through its governance structure. We also service our clients at the operating entity level to control the operation of their family assets in a compliant and effective manner.',
  ...
  "main.assets.license.id3": 'The License in China: Polaris Australis Capital (China) Co. Ltd (Pending)',
  ...
  "team.team.shang.desc": 'Many years of experience in the fintech industry, emerging asset management and serving high net worth clients. He has extensive experience in immigration services, property investment and fintech industries.',
  ...
  'contact.banner.desc.v2': ' Establish protection to deal with many challengers through the whole life cycles',
  'contact.contact.title': 'Contact Detail',
  'contact.correlation.title': 'Associated Licensed Parties',
  'footer.copyRight': 'Copyright © 2022 Huiwen Investment All rights reserved.',
};
